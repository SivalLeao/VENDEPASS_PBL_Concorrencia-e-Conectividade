...
<div id="arquitetura">
    ...
    <div align="justify">
        ...
        <p>
            Os voos podem ser comprados por qualquer cliente desde que o voo esteja disponível, ou seja, que nenhum cliente tenha a posse.
        </p>
        <p>
...
<div id="comunicacao">
    ...
    <div align="justify">
    <p>
        Toda a comunicação do sistema foi projetada sobre o modelo TCP/IP, tratando-se de uma comunicação orientada a conexão, no qual deve haver a garantia de conexão estabelecida antes de qualquer comunicação, e que toda informação deve ser devidamente entregue e em sua ordem proposta. Além disso, como o servidor armazena informações de quais usuários já se conectaram e cadastraram, tal como quais deles já efetuaram compras de passagens, diz-se que é aplicado o paradigma de serviço stateful, caracterizado por um servidor  que mantém o estado das interações com clientes.
    </p>
    <p>
    ...
    <p>
        ...
        <ol>
            ...
            <li>
                ...
                <ol type="a">
                    <li>
                        O servidor inicia a etapa enviando para o cliente a lista de todos os possíveis destinos e se estes estão ocupados ou não
                    </li>
                    <li>
